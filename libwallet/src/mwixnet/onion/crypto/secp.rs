...
pub fn sign(
	sk: &SecretKey,
	msg: &echo_util::secp::Message,
) -> Result<echo_util::secp::Signature, secp256k1zkp::Error> {
	let secp = Secp256k1::with_caps(ContextFlag::Full);
	let pubkey = echo_util::secp::PublicKey::from_secret_key(&secp, &sk)?;
	let sig = echo_util::secp::aggsig::sign_single(
		&secp,
		&msg,
		&sk,
		None,
