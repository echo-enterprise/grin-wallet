...
pub trait OwnerRpc {
	...
	```
	# echo_wallet_api::doctest_helper_json_rpc_owner_assert_response!(
	# r#"
	{
		"jsonrpc": "2.0",
		"method": "accounts",
	...
	*/
	...
	parameter. See  (../echo_wallet_libwallet/types.struct.RetrieveTxQueryArgs.html)
...
macro_rules! doctest_helper_json_rpc_owner_assert_response {
	($request:expr, $expected_response:expr, $blocks_to_mine:expr, $perform_tx:expr, $lock_tx:expr, $finalize_tx:expr, $payment_proof:expr) => {
		...
		{
			use echo_wallet_api::run_doctest_owner;
			use serde_json;
