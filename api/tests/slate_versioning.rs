...
//use echo_wallet_api::foreign_rpc_client;
use echo_wallet_api::run_doctest_foreign;
//use echo_wallet_libwallet::VersionedSlate;
use serde_json;
use serde_json::Value;
use tempfile::tempdir;
//use echo_wallet_libwallet::slate_versions::v1::SlateV1;
//use echo_wallet_libwallet::slate_versions::v2::SlateV2;
